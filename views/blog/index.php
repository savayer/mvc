...
<head>
	<meta charset="utf-8" />
	<title>Блог. Последние статьи</title>
...
<body>
	...
	<div class="container">
		<div class="col-md-3">
			...
			<a href="blog" class="link"><h3>Последние</h3></a><br>
			<h3>Категории</h3>
			<a href="blog/sport" class="link">Спорт</a><br>
			<a href="blog/music" class="link">Музыка</a><br>
			<a href="blog/films" class="link">Фильмы</a><br>
			<a href="blog/science" class="link">Наука</a><br>
			<a href="blog/entertainments" class="link">Развлечения</a><br>
			<a href="blog/programming" class="link">Программирование</a><br>
			<a href="blog/other" class="link">Прочее</a><br>
		</div>
		<div class="col-md-9">
		<?php foreach ($list as $item): ?>
			<div class="post">
				<h2 class="title"><?php echo $item['title'] ?></h2>				
					<?php echo $item['date'] ?>
					Комментариев: <?php echo $item['count'] ?>
					<a href="blog/<?php echo $item['category']; ?>" class="link_obl"><?php echo $item['category'] ?></a>
			
				<p><?php echo $item['short_text'] ?></p>
				<a href="blog/<?php echo $item['category']; echo "/"; echo $item['id_article'] ?>" class="read_more">Read more</a>	
			</div>
			<?php endforeach; ?>
		</div>
	</div>
